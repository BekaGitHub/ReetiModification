...
//  }
  ...
  /**
   * Load an image icon from the specified resource which is resolved relative to this class.
   *
  ...
  /**
   * Load an image icon from the specified resource which is resolved relative to the specified base
   * class.
   *
  ...
  /**
   * Load an image from the specified resource which is resolved relative to this class.
   *
   * @param resource the resource to load
   * @return an image icon
   */
  ...
  /**
   * Load an image from the specified resource which is resolved relative to the specified base
   * class.
   *
   * @param base the base class against which the resource is resolved
   * @param resource the resource to load
