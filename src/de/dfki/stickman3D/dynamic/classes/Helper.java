...
public class Helper {
  ...
  public static void switchRecordID(String ID, StickmanStageController controller) {
    ...
    switch (ID) {
      case "rec0":
        ...
        appendMethodCommands("head", XYZ[0], XYZ[1], XYZ[2]);
      ...
      case "rec3":
        ...
        appendMethodCommands("mLeftForeArm", XYZ[0] + leftForeArmXOffset, XYZ[1],
            XYZ[2] + leftForeArmZOffset);
      ...
      case "rec10":
        ...
        appendMethodCommands("mRightForeArm", XYZ[0] + rightForeArmXOffset, XYZ[1],
            XYZ[2] + rightForeArmZOffset);
  ...
  private static void appendMethodCommands(String bodypart, int x, int y, int z) {
    DynamicCompiler.methodContent.append("animationContents = new ArrayList<>(); \n");
    DynamicCompiler.methodContent
        .append("animationContents.add(new AnimationContent3D(mStickmanSwing.").append(bodypart)
    ...
    DynamicCompiler.methodContent.append("playAnimationPart(duration);\n");
  }
