...
public abstract class AbstractConversationHands extends AnimationStickman3D {
  ...
  protected void moveConversationHands() {
    ...
    moveArms(new AnimationContent3D(mStickman3D.mRightForeArm, "zrotate", rightForeArmZ),
        new AnimationContent3D(mStickman3D.mLeftForeArm, "zrotate", leftForeArmZ));
  }
  ...
  protected void moveArms(AnimationContent3D zrotate, AnimationContent3D zrotate2) {
    animationContents.add(zrotate);
    animationContents.add(zrotate2);
  }
