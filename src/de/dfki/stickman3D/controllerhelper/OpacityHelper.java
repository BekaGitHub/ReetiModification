...
public class OpacityHelper {
  ...
  public static void headOpacityChanger(StickmanStageController controller,
      Slider headOpacitySlider) {
  ...
  public static void hairOpacityChanger(StickmanStageController controller,
      Slider hairOpacitySlider) {
  ...
  public static void bodyOpacityChanger(StickmanStageController controller,
      Slider bodyOpacitySlider) {
  ...
  public static void limbsOpacityChanger(StickmanStageController controller,
      Slider limbsOpacitySlider) {
  ...
  public static void shoesOpacityChanger(StickmanStageController controller,
      Slider shoesOpacitySlider) {
  ...
  public static void lipsOpacityChanger(StickmanStageController controller,
      Slider lipsOpacitySlider) {
  ...
  public static void eyeOpacityChanger(StickmanStageController controller,
      Slider eyeOpacitySlider) {
  ...
  public static void browOpacityChanger(StickmanStageController controller,
      Slider browOpacitySlider) {
...
//                controller.currentStickman.mNose.posOnScreen();
  ...
  public static void noseOpacityChanger(StickmanStageController controller,
      Slider noseOpacitySlider) {
