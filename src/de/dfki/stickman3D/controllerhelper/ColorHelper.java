    ...
    if (sSC.currentStickman != null) {
      if (ev.getSource().equals(sSC.hairColorBrighter)) {
        if (sSC.currentStickman.mType == Gender.TYPE.MALE) {
          ...
          sSC.currentStickman.mFemaleHair.mColor = sSC.currentStickman.mFemaleHair.mColor
              .brighter();
  ...
  public static void handlelimbsColorButtons(StickmanStageController sSC,
    ...
    if (sSC.currentStickman != null) {
      if (ev.getSource().equals(sSC.limbsColorBrighter)) {
        ...
        sSC.currentStickman.mLeftUpperArm.mColor = sSC.currentStickman.mLeftUpperArm.mColor
            .brighter();
        sSC.currentStickman.mLeftForeArm.mColor = sSC.currentStickman.mLeftForeArm.mColor
            .brighter();
        sSC.currentStickman.mLeftWrist.mColor = sSC.currentStickman.mLeftWrist.mColor.brighter();
        sSC.currentStickman.mLeftFinger1.mColor = sSC.currentStickman.mLeftFinger1.mColor
            .brighter();
        sSC.currentStickman.mLeftFinger2.mColor = sSC.currentStickman.mLeftFinger2.mColor
            .brighter();
        sSC.currentStickman.mLeftFinger3.mColor = sSC.currentStickman.mLeftFinger3.mColor
            .brighter();
        sSC.currentStickman.mLeftFinger4.mColor = sSC.currentStickman.mLeftFinger4.mColor
            .brighter();
        sSC.currentStickman.mLeftUpperLeg.mColor = sSC.currentStickman.mLeftUpperLeg.mColor
            .brighter();
        sSC.currentStickman.mLeftForeLeg.mColor = sSC.currentStickman.mLeftForeLeg.mColor
            .brighter();

        sSC.currentStickman.mRightUpperArm.mColor = sSC.currentStickman.mRightUpperArm.mColor
            .brighter();
        sSC.currentStickman.mRightForeArm.mColor = sSC.currentStickman.mRightForeArm.mColor
            .brighter();
        sSC.currentStickman.mRightWrist.mColor = sSC.currentStickman.mRightWrist.mColor.brighter();
        sSC.currentStickman.mRightFinger1.mColor = sSC.currentStickman.mRightFinger1.mColor
            .brighter();
        sSC.currentStickman.mRightFinger2.mColor = sSC.currentStickman.mRightFinger2.mColor
            .brighter();
        sSC.currentStickman.mRightFinger3.mColor = sSC.currentStickman.mRightFinger3.mColor
            .brighter();
        sSC.currentStickman.mRightFinger4.mColor = sSC.currentStickman.mRightFinger4.mColor
            .brighter();
        sSC.currentStickman.mRightUpperLeg.mColor = sSC.currentStickman.mRightUpperLeg.mColor
            .brighter();
        sSC.currentStickman.mRightForeLeg.mColor = sSC.currentStickman.mRightForeLeg.mColor
            .brighter();
  ...
  public static void handleBrowColorButtons(StickmanStageController sSC, MouseEvent ev) {
    if (sSC.currentStickman != null) {
      if (ev.getSource().equals(sSC.browColorBrighter)) {
        sSC.currentStickman.mLeftEyebrow.mColor = sSC.currentStickman.mLeftEyebrow.mColor
            .brighter();
        sSC.currentStickman.mRightEyebrow.mColor = sSC.currentStickman.mRightEyebrow.mColor
            .brighter();
