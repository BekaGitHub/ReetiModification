...
public class StickmanData3D {
  ...
  public StickmanData3D(String name, String hairColor, String headColor, String bodyColor,
      String limbsColor, String shoesColor, String lipsColor, String eyesColor, String browsColor,
      String nosesColor, String backgroundRecord) {
    this.name = name;
