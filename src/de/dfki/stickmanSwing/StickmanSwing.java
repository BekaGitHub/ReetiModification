...
/**
 * @author Patrick Gebhard <p> This work is inspired by the stickmans drawn by Sarah Johnson
...
public class StickmanSwing extends JComponent implements AgentInterface {
  ...
  public AnimationSwing doEventFeedbackAnimation(String name, int duration,
      WordTimeMarkSequence wts, boolean block) {

    EventAnimationSwing a = AnimationLoaderSwing.getInstance()
  ...
  public AnimationSwing doAnimation(String name, int duration, Object param, boolean block) {
    AnimationSwing a = AnimationLoaderSwing.getInstance()
  ...
  protected void paintComponent(Graphics g) {
    ...
    at.rotate(Math.toRadians(mWobble),
        (mBody.getRightLegStartPostion().x + mBody.getLeftLegStartPostion().x) / 2,
