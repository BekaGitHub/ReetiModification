...
//			animationContents.add(new AnimationContentSwing(mStickmanSwing.mWordShow, "shape", "SAYHI"));
//			playAnimationPart(2);	
//		}
//		show stars
...
//		disappeared words or stars
    animationContents = new ArrayList<>();
    animationContents.add(new AnimationContentSwing(mStickman.mStars, "shape", "DEFAULT"));
    playAnimationPart(2);
