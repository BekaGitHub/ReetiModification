...
public class Speaking extends AnimationSwing {
  ...
  public void playAnimation() {
    if (parameter instanceof String) {
      mStickmanSwing.mSpeechBubble.mText = (String) parameter;
    }

    animationContents = new ArrayList<>();
    animationContents
        .add(new AnimationContentSwing(mStickmanSwing.mSpeechBubble, "shape",
            SpeechBubble.SHAPE.SPEAK.name()));
    playAnimationPart(duration);

    animationContents
        .add(new AnimationContentSwing(mStickmanSwing.mSpeechBubble, "shape",
            SpeechBubble.SHAPE.DEFAULT.name()));
