...
public class Head extends StickmanSwingParts {
  ...
  public void calculate(int step) {
    ...
    mHead.curveTo(mEarWidth, -mHalfHeight / 5, mSize.width, -mHalfHeight / 5, mSize.width,
        mHalfHeight);
    ...
    mRightEar
        .curveTo(mSize.width + 10, mSize.height / 2 - 10, mSize.width + 10, mSize.height / 2 + 10,
            mSize.width, mSize.height / 2 + 10);
    t = new AffineTransform();
    t.rotate(Math.toRadians(mRotation), mDefaultRotationPoint.x, mDefaultRotationPoint.y);
    t.translate(-1, 3 + mTranslation);
    ...
    // top hair
    mFemaleHair
        .curveTo(mEarWidth + 20, -mHalfHeight / 8, mSize.width - 20, -mHalfHeight / 8, mSize.width,
            mHalfHeight);
    // left top locke
    mFemaleHair.quadTo(mEarWidth + mSize.width - 20, mSize.height, mSize.width + mEarWidth,
        mSize.height + 20);
    // left down locke
    mFemaleHair.quadTo(mSize.width - 10, mSize.height + 30, mSize.width - 10, mSize.height + 20);
    // forehead hair
    mFemaleHair.curveTo(mSize.width + 30, -mHalfHeight / 4, mStart.x - 20, -mHalfHeight / 4,
    ...
    mMaleHair.curveTo(mSize.width, -mHalfHeight / 2, mEarWidth, -mHalfHeight / 2, mEarWidth,
        mHalfHeight);
