...
public class LeftForeArm extends StickmanSwingParts {
  ...
  protected void paintComponent(Graphics g) {
    ...
    if (mUpperArm.mLeftShoulder.mBody.mNeck.mHead.mStickman.setCharacterInvisible == true) {
      if (mUpperArm.mLeftShoulder.mBody.mNeck.mHead.mStickman.fadeControler
          == true) //Added by Robbie
      {
        int fadeFactor =
            mUpperArm.mLeftShoulder.mBody.mNeck.mHead.mStickman.mMouth.mShapeAnimationStep * 12;
        if (fadeFactor <= 24) {
          fadeFactor = 0;
        }
        ...
        int fadeFactor =
            (20 - mUpperArm.mLeftShoulder.mBody.mNeck.mHead.mStickman.mMouth.mShapeAnimationStep)
                * 12;
        if (fadeFactor >= 216) {
          fadeFactor = 255;
        }
