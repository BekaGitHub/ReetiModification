  ...
  public void createShape() {
    ...
    switch (mShape) {
      case DEFAULT:
        ...
        if (mHead.mStickman.setCharacterInvisible == true) {
          if (mHead.mStickman.fadeControler == true) //Added by Robbie
          {
            ...
            mColor = new Color(mHead.mStickman.mType == Gender.TYPE.FEMALE ? 64 : 32, 0, 0,
                fadeFactor);
          } else {
      ...
      case ANGRY:
        ...
        gp.quadTo(mStart.x, mStart.y + 1 - movement / 3 * 2, mEnd.x + movement / 4,
      ...
      case ANGRYSMALLMOUTH:
        ...
        gp.quadTo(mStart.x, mStart.y + 1 - movement / 4, mEnd.x - movement / 10,
            mStart.y + movement / 10);
        break;
      ...
      case SURPRISED:
        ...
        gp.moveTo(mStart.x - mLength / 2, mStart.y);
        gp.quadTo(mStart.x - movement / 4 - 4, mStart.y - movement / 2, mStart.x,
            mStart.y - movement / 2 - 1);
        gp.quadTo(mStart.x + movement / 4 + 4, mStart.y - movement / 2, mEnd.x, mStart.y);
        gp.quadTo(mStart.x + movement / 4 + 4, mStart.y + movement / 2, mStart.x,
            mStart.y + movement / 2 + 1);
        gp.quadTo(mStart.x - movement / 4 - 4, mStart.y + movement / 2, mStart.x - mLength / 2,
            mStart.y);
        break;
      ...
      case HAPPY:
        ...
        gp.moveTo(mStart.x - mLength / 2 - movement / 2, mStart.y - movement / 4);
        gp.quadTo(mStart.x, mStart.y + 1 + movement, mEnd.x + movement / 2,
            mStart.y - movement / 4);
      ...
      case DISGUSTED:
        ...
        gp.quadTo(mStart.x - movement * 2 / 3, mStart.y - movement / 4, mStart.x - movement / 3,
            mStart.y);
        gp.quadTo(mStart.x, mStart.y + movement / 4, mStart.x + movement / 3, mStart.y);
        gp.quadTo(mStart.x + movement * 2 / 3, mStart.y - movement / 4, mStart.x + movement,
            mEnd.y);
        break;
      ...
      case CONTEMPT:
        ...
        gp.moveTo(mStart.x - mLength / 2, mStart.y);
        gp.quadTo(mStart.x, mStart.y - movement / 1.5, mEnd.x + movement / 2,
            mEnd.y - movement / 2);
        break;
      ...
      case EXCITED:
        ...
        gp.moveTo(mStart.x - mLength / 2 - movement / 3 * 2, mStart.y - movement / 2);
        gp.quadTo(mStart.x, mStart.y + movement, mEnd.x + movement / 3 * 2,
            mStart.y - movement / 2);
