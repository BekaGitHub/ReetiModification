...
//		nEmd: right side
    ...
    switch (mShape) {
      ...
      case LOOKLEFT:
        gp.moveTo(mStart.x, mStart.y);
        gp.quadTo(linear((mStart.x + mEnd.x) / 2, mEnd.x, mShapeAnimationStep), mStart.y - 3,
            mEnd.x, mEnd.y);
        break;
      ...
      case LOOKRIGHT:
        gp = new GeneralPath();
        gp.moveTo(mStart.x, mStart.y);
        gp.quadTo(linear((mStart.x + mEnd.x) / 2, mStart.x, mShapeAnimationStep), mStart.y - 3,
            mEnd.x, mEnd.y);
        break;
      ...
      case SURPRISEDEND:
        ...
        if (movement <= 1) {
          ...
          gp.moveTo(mStart.x - movement / 10, mStart.y);
          gp.quadTo((mStart.x - movement / 10 + mEnd.x + movement / 10) / 2,
      ...
      case HAPPY:
        ...
        gp.moveTo(mStart.x - movement / 10, mStart.y);
        gp.quadTo((mStart.x - movement / 10 + mEnd.x + movement / 10) / 2, mStart.y - 3,
      ...
      case EMBARRASSED:
        ...
        gp.quadTo((mStart.x + movement / 2 + mEnd.x + movement / 2) / 2,
