...
public class Body extends JComponent {
  ...
  private void calculate() {
    ...
    mFemaleBodyFront
        .quadTo(mStart.x, mHalfSizeY + mDrawOffset, mStart.x + mHalfSizeX, mSize.height + 10);

    mFemaleBodyFront
        .curveTo(mStart.x + mHalfSizeX - 40, mSize.height - 10, mStart.x - mHalfSizeX + 40,
            mSize.height + 20, mStart.x - mHalfSizeX, mSize.height);

    //mFemaleBodyFront.lineTo(mStart.x - mHalfSizeX, size.height);
    ...
    mMaleBodyFront.quadTo(mStart.x, mHalfSizeY + mDrawOffset, mStart.x + mHalfSizeX - mDrawOffset,
        mSize.height);
