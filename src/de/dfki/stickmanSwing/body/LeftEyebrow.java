...
//		mEnd: right side
    ...
    switch (mShape) {
      ...
      case ANGRY:
        ...
        gp.quadTo((mStart.x - movement / 4 + mEnd.x - movement / 3) / 2,
      ...
      case DISGUSTED:
        ...
        gp.quadTo((mStart.x + mEnd.x) / 2, mStart.y - 3 + movement / 7, mEnd.x - movement / 10,
            mEnd.y);
        break;
      ...
      case SURPRISED:
        ...
        gp.quadTo((mStart.x + mEnd.x) / 2, mStart.y - 3 - movement / 7, mEnd.x,
            mEnd.y - movement / 7);
        break;
      ...
      case EXCITED:
        ...
        gp.moveTo(mStart.x, mStart.y - movement / 4);
        gp.quadTo((mStart.x + mEnd.x) / 2, mStart.y - 3 - movement / 5, mEnd.x,
            mEnd.y - movement / 4);
        break;
