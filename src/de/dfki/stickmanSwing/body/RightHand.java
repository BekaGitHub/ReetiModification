...
public class RightHand extends StickmanSwingParts {
  ...
  public void createShape() {
    ...
    if (mRightForeArm.mUpperArm.mRightShoulder.mBody.mNeck.mHead.mStickman.setCharacterInvisible
        == true) {
      if (mRightForeArm.mUpperArm.mRightShoulder.mBody.mNeck.mHead.mStickman.fadeControler
