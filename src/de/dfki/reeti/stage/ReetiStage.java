...
public class ReetiStage extends Application implements AgentStage {
  ...
  public void start(Stage stage) throws Exception {
    ...
    mSubscene = createSubSceneAndCamera(getmReetiHBox(), getWidth() - controlPanel.getPrefWidth(),
        getHeight());
  ...
  public float getFullScreenScale() {
    return getHeight() / (float) de.dfki.stickmanFX.StickmanFX.mDefaultSize.height * mScale
        * REETI_SIZE_FACTOR;
  }
...
//            reeti.setReetiOnScreen();
          } else {
//            reeti.setReetiOnScreen(150);
          }
