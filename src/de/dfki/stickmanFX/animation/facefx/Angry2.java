...
public class Angry2 extends AnimationStickmanFX {
  ...
  public void playAnimation() {
    ...
    animationContents
        .add(new AnimationContentFX(mStickmanFX.mLeftUpperArmFX, "rotate", -(rotationUnit + 3)));
    ...
    if (mStickmanFX.mType == Gender.TYPE.MALE) {
      ...
      animationContents
          .add(new AnimationContentFX(mStickmanFX.mLeftForeArmFX, "rotate", rotationUnit - 20));
    }

    animationContents.add(new AnimationContentFX(mStickmanFX.mLeftHandFX, "rotate", rotationUnit));
    ...
    for (int i = 0; i < 8; i++) {
      animationContents = new ArrayList<>();
      animationContents.add(new AnimationContentFX(mStickmanFX.mRightFootFX, "rotate", 40));
