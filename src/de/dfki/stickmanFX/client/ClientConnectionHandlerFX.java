...
public class ClientConnectionHandlerFX extends Thread implements CommonClientConnectionHandler {
  ...
  @Override
  public void connect() {
    StickmanStageSwing.mLogger
        .info("StickmanStageSwing tries to connect with control application ...");
    try {
    ...
    mConnected = true;
    StickmanStageSwing.mLogger
        .info("StickmanStageSwing connected to control application at " + mSocket.toString());
    // register at server
