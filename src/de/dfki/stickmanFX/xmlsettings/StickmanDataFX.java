...
public class StickmanDataFX {
  ...
  public StickmanDataFX(String name, String hairColor, String headColor, String bodyColor,
      String limbsColor, float hairColorOpacity, float headColorOpacity, float bodyColorOpacity,
      float limbsColorOpacity, String backgroundRecord) {
    this.name = name;
