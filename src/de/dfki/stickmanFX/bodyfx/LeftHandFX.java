...
public class LeftHandFX extends StickmanFXParts {
  ...
  public void createShape() {
    ...
    clearChildren(this);
    mHand = new Path();
//        if (mLeftForeArm.mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeck.head.mStickmanSwing.setCharacterInvisible == false) {
//        	mColorRecorder = mColor;
//        }
    if (mLeftForeArmFX.mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.setCharacterInvisible
        == true) {
      if (mLeftForeArmFX.mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.fadeControler
          == true) //Added by Robbie
      {
        int fadeFactor =
            mLeftForeArmFX.mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mMouthFX.mShapeAnimationStep
                * 12;
        if (fadeFactor <= 24) {
          fadeFactor = 0;
        }
