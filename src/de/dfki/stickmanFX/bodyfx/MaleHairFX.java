...
public class MaleHairFX extends StickmanFXParts {
  ...
  public void calculate(int step) {
    ...
    mMaleHair.getElements()
        .add(new QuadCurveTo(mHalfWidth - 30, -mHalfHeight / 3, mHalfWidth + 20, mHalfHeight - 30));
    mMaleHair.getElements()
        .add(new QuadCurveTo((mHalfWidth + 40 + mSize.width) / 2, 0, mSize.width, mHalfHeight));
    mMaleHair.getElements().add(
        new CubicCurveTo(mSize.width, -mHalfHeight / 2, mEarWidth, -mHalfHeight / 2, mEarWidth,
            mHalfHeight));
