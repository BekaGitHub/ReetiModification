...
public class LeftForeArmFX extends StickmanFXParts {
  ...
  public Point getHandStartPosition() {
    if (mRotation >= 0 && mRotation <= 90) {
      ...
      return (mArm != null) ? new Point((int) (mArm.boundsInParentProperty().get().getMinX() - 6),
          (int) mArm.boundsInParentProperty().get().getMinY()) : new Point(0, 0);
    } else if (mRotation < 0 && mRotation >= -90) {
      return (mArm != null) ? new Point((int) (mArm.boundsInParentProperty().get().getMaxX() - 7),
          (int) mArm.boundsInParentProperty().get().getMaxY()) : new Point(0, 0);
    } else {
      return (mArm != null) ? new Point((int) (mArm.boundsInParentProperty().get().getMaxX() - 7),
          (int) mArm.boundsInParentProperty().get().getMinY()) : new Point(0, 0);
...
//        Color currentColor = Color.rgb(80, 80, 80);
    ...
    if (mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.setCharacterInvisible
        == true) {
      if (mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.fadeControler
