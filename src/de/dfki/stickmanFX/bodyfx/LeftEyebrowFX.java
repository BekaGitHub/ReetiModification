...
//            		mColorRecorder = color;
      ...
      case ANGRY:
        ...
        mPath.getElements().add(
            new QuadCurveTo((mStart.x - movement / 4 + mEnd.x - movement / 3) / 2,
      ...
      case DISGUSTED:
        ...
        mPath.getElements().add(
            new QuadCurveTo((mStart.x + mEnd.x) / 2, mStart.y - 3 + movement / 7,
      ...
      case SURPRISED:
        ...
        mPath.getElements().add(
            new QuadCurveTo((mStart.x + mEnd.x) / 2, mStart.y - 3 - movement / 7, mEnd.x,
                mEnd.y - movement / 7));
        break;
      ...
      case EXCITED:
        ...
        mPath.getElements().add(new MoveTo(mStart.x, mStart.y - movement / 4));
        mPath.getElements().add(
            new QuadCurveTo((mStart.x + mEnd.x) / 2, mStart.y - 3 - movement / 5, mEnd.x,
                mEnd.y - movement / 4));
        break;
