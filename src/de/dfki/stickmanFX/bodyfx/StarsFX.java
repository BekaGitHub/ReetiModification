  ...
  public void createShape() {
    ...
    switch (mShape) {
      ...
      case SAYBYE:
        ...
        path.getElements().add(new MoveTo(mStart.x - 100, mStart.y));
        path.getElements().add(new QuadCurveTo(mStart.x - 100 + 70, mStart.y + 30, mStart.x - 100,
            mStart.y + mLength / 2));
        path.getElements().add(new MoveTo(mStart.x - 100, mStart.y + mLength / 2));
        path.getElements()
            .add(new QuadCurveTo(mStart.x - 100 + 70, mEnd.y - 40, mEnd.x - 100, mEnd.y));
...
//					mStart = mBodyFX.getLeftLegStartPostion();
          ...
          // STAR 2 right side
//					mStart = mBodyFX.mNeck.head.mStickmanSwing.mLeftForeLegFX.getLegStartPosition();
          mStart = mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mRightUpperArmFX
              .getRightUpperArmEndPosition();
          creatStar(15, mStart, path);

          // STAR 3 left side
//					mStart = mBodyFX.mNeck.head.mStickmanSwing.mRightUpperLegFX.getRightUpperLegEndPosition();
