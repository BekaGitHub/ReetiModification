...
public class LeftUpperArmFX extends StickmanFXParts {
  ...
  public Point getLeftUpperArmEndPosition() {
    ...
    if (mRotation >= 0 && mRotation <= 90) {
      ...
      return (mArm != null) ? new Point((int) (mArm.boundsInParentProperty().get().getMaxX() - 1),
...
//        Color currentColor = Color.rgb(80, 80, 80);
    ...
    if (mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.setCharacterInvisible == true) {
      ...
      {
        int fadeFactor =
            mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mMouthFX.mShapeAnimationStep * 12;
        if (fadeFactor <= 24) {
          fadeFactor = 0;
        }
        ...
        int fadeFactor =
            (20 - mLeftShoulderFX.mBodyFX.mNeckFX.mHeadFX.mStickmanFX.mMouthFX.mShapeAnimationStep)
                * 12;
        if (fadeFactor >= 216) {
